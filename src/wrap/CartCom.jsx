...
export default function CartCom(){
    ...
    const cartDBUpdateListSelect=(사용자아이디)=>{
        ...
        axios({
            url: 'https://gwonsj94.co.kr/innisfree/innisfree_cart_table_select.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const cartDBUpdate=(사용자아이디, 제품코드, 결과)=>{
        ...
        axios({
            url: 'https://gwonsj94.co.kr/innisfree/innisfree_cart_table_update.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const cartDBDelete=(사용자아이디, 제품코드)=>{
        ...
        formData.append('제품코드', 제품코드);
        axios({
            url: 'https://gwonsj94.co.kr/innisfree/innisfree_cart_table_delete.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
