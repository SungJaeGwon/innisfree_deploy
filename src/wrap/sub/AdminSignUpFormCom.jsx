...
export default function AdminSignUpFormCom () {
    ...
    const onClickDuplicationId=(e)=>{
        ...
        if( value.length > 12 || regexp1.test(value)===false || regexp2.test(value)===true ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/innisfree/innisfree_admin_id_duplication.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
    ...
    const onClickDuplicationEmail=(e)=>{
        ...
        if( value==='' ){
            ...
            axios({
                url: 'https://gwonsj94.co.kr/innisfree/innisfree_admin_email_duplication.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
    ...
    const onsubmitForm=(e)=>{
        ...
        if( state.id===''){
            ...
            formData.append('adminBirth', `${state.birthYear}.${state.birthMonth}.${state.birthDate}` );
            formData.append('adminId', state.id);
            ...
            axios({
                url:'https://gwonsj94.co.kr/innisfree/innisfree_admin_insert.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
