...
export default function AdminUserinfoModifyCom(){
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.pw===''){
            ...
            axios({
                url:'https://gwonsj94.co.kr/innisfree/innisfree_admin_userinfo_modify.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{               
    ...
    const onClickModalClose=(e)=>{
     ...
     const onClickDelete=(e)=>{
        ...
        axios({
            url:'https://gwonsj94.co.kr/innisfree/innisfree_admin_userinfo_delete.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{               
